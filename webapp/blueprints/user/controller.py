...
from blueprints.user.forms import LoginForm, BeginPasswordResetForm, PasswordResetForm, SignupForm, WelcomeForm, UpdateCredentials

user = Blueprint('user', __name__, template_folder='views', url_prefix="/user")
...
def begin_password_reset():
    ...
    return render_template('user_begin_password_reset.html', form=form)
...
def welcome():
    ...
    return render_template('user_welcome.html', form=form)
...
def update_credentials():
    ...
    return render_template('user_update_credentials.html', form=form)
